...
def build_network():
    ...
    global FC1, fc1
    FC1 = FullConnectLayer(x , 256, tf.nn.relu)
...
test_batch = test_NP.next_batch(-1)
final_test_accuracy = accuracy.eval(feed_dict={x: test_batch[0], y_: test_batch[1], keep_prob: 1.0})
print("final_test_accuracy = %f"%final_test_accuracy)

matrix_fc1 = FC1.Weight.eval()
print(matrix_fc1)
